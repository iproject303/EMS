  ...
  <ul class="sidebar navbar-nav">
    ...
    <div class="card mb-3">
      ...
      <tr>
                ...
                <td>
                 <input <?php echo $idattr; ?> type="text" name="userId" value="<?php echo $row['userId']; ?>" > </td>
...
<tr>
  <td>
                ...
                <td>
                <input type="text" name="userName" value="<?php echo $row['user_name']; ?>"  ></td>
...
<tr>
  ...
  <td>
             <input type ="submit" value="<?php echo $coluser ?> User" id="btnadd" class="btn btn-info" onclick="submitForm('<?php echo $fileuser ?>')"></td>
